...
The implementation, the data pipeline and every number, table and figure in this document are in the companion repository at \url{https://github.com/BreimAlaa/btc-tvtp}. A single script there runs the unit tests, the Monte Carlo study, the walk-forward on real data and the three-regime and Student-$t$ robustness variants, regenerates the tables and recompiles this document from the public Coin Metrics data; all random seeds are fixed.
...
\input{generated/tab_strat.tex}
\input{generated/tab_sig.tex}
\input{generated/tab_cost.tex}
